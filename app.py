...
def render_results():
    ...
    try:
        default_tab = tab_labels[ELEMENT_ORDER.index(short_elem)]
...
**情感特质**：情感共鸣极强，彼此能深刻理解对方的情绪需求，是灵魂知己般的存在。

**学习建议**：适合一起学习心理学、文学、艺术等人文领域，互相分享感受能加深理解。

**工作建议**：在团队中是出色的倾听者和协调者，适合从事客服、HR、心理咨询等需要同理心的工作。

**生活建议**：一起享受安静的时光，如品茶、看电影、深度聊天，都是增进感情的好方式。

**💡 双方改进建议**：
- 水元素过强容易情绪化，建议制定「冷静期」规则，避免冲动决策
- 共同培养一项理性爱好（如编程、理财）平衡感性倾向
- 定期设定共同目标，避免陷入过度内省而缺乏行动""",
    ("水", "火"): """💧🔥 水火相济 · 激情与温柔

**情感特质**：感性遇上行动力，互补性极强。水能软化火的急躁，火能带动水的激情，是经典的「吸引力组合」。

**学习建议**：水可以帮助火培养耐心，火可以带动水付诸行动，搭配学习效率极高。

**工作建议**：火负责开拓和执行，水负责细节和沟通，是创业的绝佳搭档。

**生活建议**：火带来热闹与活力，水营造温馨与浪漫，生活既有激情又有温情。

**💡 双方改进建议**：
- 火元素需学习倾听，避免打断水的表达
- 水元素需学会果断，在关键时刻给予明确支持
- 约定「争吵暂停键」，避免情绪激化""",
    ("水", "风"): """💧🌬️ 流水遇风 · 智慧与情感

**情感特质**：交流畅快，精神层面高度契合。水的情感深度加上风的思维广度，能碰撞出大量创意火花。

**学习建议**：一起读书讨论、参加讲座，在思想碰撞中共同成长。

**工作建议**：适合从事创意产业、媒体、教育等需要思想交流的领域。

**生活建议**：一起旅行探索，在新环境中激发灵感，丰富彼此的精神世界。

**💡 双方改进建议**：
- 风元素需注意表达的温度，避免过于理性伤害水的情感
- 水元素需理解风的跳跃思维，给予更多空间
- 每周安排「深度对话时间」，确保情感连接不被忙碌冲淡""",
    ("水", "土"): """💧🌍 静水深流 · 温暖与安稳

**情感特质**：水的包容遇上土的稳重，关系踏实而温暖。水需要土的可靠肩膀，土需要水的柔情滋养。

**学习建议**：土的结构化学习法配合水的情感记忆，学习效果加倍。

**工作建议**：土负责规划执行，水负责人际协调，是稳定可靠的工作伙伴。

**生活建议**：土营造安稳的生活环境，水注入温馨的情感氛围，家庭幸福感高。

**💡 双方改进建议**：
- 土元素需学习表达情感，不要只靠行动证明关心
- 水元素需理解土的务实，不要期待过多浪漫
- 共同制定家庭计划，既有安全感又有情感交流""",
    ("火", "火"): """🔥🔥 双火组合 · 热情似火

**情感特质**：热情似火、能量爆棚，在一起永远不会无聊。但需注意控制脾气，避免「火上加火」的争吵。

**学习建议**：适合挑战高难度任务，互相激励能突破极限。

**工作建议**：在销售、市场、创业等领域能爆发惊人能量，是天生的领导者组合。

**生活建议**：一起运动、旅行、尝试新事物，生活充满冒险与刺激。

**💡 双方改进建议**：
- 学习「暂停与倾听」技巧，避免争强好胜
- 设定共同目标，将竞争转化为合作
- 培养一项需要耐心的共同爱好（如园艺、乐器）""",
    ("火", "风"): """🔥🌬️ 风助火势 · 创意与行动

**情感特质**：火提供动力，风提供创意，是充满活力的组合。适合一起创业、旅行、探索未知。

**学习建议**：风提供多元视角，火推动快速实践，学习效率高。

**工作建议**：风负责创意策划，火负责落地执行，是开拓市场的黄金组合。

**生活建议**：一起参加活动、结识新朋友，社交生活丰富多彩。
...
**情感特质**：火的激情点燃土的潜力，土的稳重为火提供坚实后盾。是「梦想家+实干家」的黄金搭档。

**学习建议**：火激发学习热情，土制定学习计划，高效又扎实。

**工作建议**：火负责愿景与开拓，土负责管理与执行，是完美的创业团队。

**生活建议**：火带来惊喜与浪漫，土确保生活品质与稳定。
...
**情感特质**：思想自由奔放，在一起总有聊不完的话题。缺点是可能缺乏落地执行力，需要互相督促。

**学习建议**：互相分享新知识，在交流中碰撞出智慧火花。

**工作建议**：适合从事科研、教育、媒体等需要创新思维的领域。

**生活建议**：一起探索新领域，参加讲座、阅读、讨论，精神生活丰富。

**💡 双方改进建议**：
- 建立「行动清单」机制，将想法转化为具体计划
- 分工合作，每人负责跟进部分任务
- 设定「完成截止日期」，避免拖延""",
    ("风", "土"): """🌬️🌍 风拂大地 · 视野与根基

**情感特质**：风带来远方的视野，土提供脚下的根基。风帮土打破惯性，土帮风落实想法，非常平衡。

**学习建议**：风带来新视角，土确保扎实掌握，学习既有广度又有深度。

**工作建议**：风负责战略规划，土负责项目管理，是稳定发展的保障。

**生活建议**：风带来新体验，土营造舒适家，生活既有变化又有安稳。

**💡 双方改进建议**：
- 风元素需耐心解释新想法，帮助土理解
- 土元素需开放心态，尝试新事物
- 制定「变化节奏」，既不墨守成规也不盲目跟风""",
    ("土", "土"): """🌍🌍 双土组合 · 坚实依靠

**情感特质**：极度稳定可靠，彼此是最坚实的依靠。生活规律有序，但需注意偶尔制造惊喜，避免过于平淡。

**学习建议**：一起制定学习计划，互相监督执行，稳扎稳打。

**工作建议**：在财务、工程、管理等领域表现出色，是值得信赖的伙伴。

**生活建议**：生活规律舒适，重视家庭传统，安全感强。

**💡 双方改进建议**：
- 定期安排「惊喜日」，打破日常routine
- 共同尝试新体验，保持关系新鲜感
- 学习表达情感，不要只靠行动传递关心"""
}
